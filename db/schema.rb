...
ActiveRecord::Schema.define(version: 2020_11_17_223256) do
  ...
  create_table "bookings", force: :cascade do |t|
    ...
    t.index ["sport_session_id"], name: "index_bookings_on_sport_session_id"
  ...
  add_foreign_key "bookings", "sport_sessions"
